...
import static org.am.library.entities.WarehouseTownCoverage.ID_TOWN_UNIQUE_INDEX_NAME;
...
@Table(name = WarehouseTownCoverage.WAREHOUSE_TOWN_COVERAGE_TABLE_NAME, uniqueConstraints = {
        @UniqueConstraint(columnNames = {ID_WAREHOUSE_UNIQUE_INDEX_NAME, ID_TOWN_UNIQUE_INDEX_NAME}, name = WarehouseTownCoverage.FK_UNIQUE_WAREHOUSE_ID_AND_TOWN_ID)
})
