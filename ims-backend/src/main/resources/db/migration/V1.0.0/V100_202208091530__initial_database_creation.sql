...
ALTER TABLE warehouse_town_coverages ADD CONSTRAINT warehouse_unique_id UNIQUE (fk_warehouse);
ALTER TABLE warehouse_town_coverages ADD CONSTRAINT town_unique_id UNIQUE (fk_town);
